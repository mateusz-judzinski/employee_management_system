...
public class LeaderController {
    ...
    public String addTemporaryPosition(@RequestParam String positionName,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "Tymczasowe stanowisko musi mieć nazwę od 3 do 30 znaków oraz opis od 10 do 250 znaków");
